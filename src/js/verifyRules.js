...
const ConditionStructurel = require("./ConditionStructurelle");
const ConditionMatching = require("./ConditionMatching");
...
function verifMain(rules, sudoc) {
    ...
    //ConditionMatching.testConditionStrucutrelRules(rules,controlfields,datafields , resultJson)
